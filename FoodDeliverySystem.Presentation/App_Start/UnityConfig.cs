...
namespace FoodDeliverySystem.Presentation
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IRestaurantCategoryRepository, RestaurantCategoryService>();
            container.RegisterType<IDiscountDetailRepository, DiscountDetailService>();
            ...
            container.RegisterType<IUserOrderRepository, UserOrderService>();
            container.RegisterType<IOrderDetailRepository, OrderDetailService>();
