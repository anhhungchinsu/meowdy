...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
        ...
        cartItemTemplate: '<img class="img-responsive pull-left" src="{product_image}" /><h4 class="list-group-item-heading text-success">{product_name}</h4><p class="list-group-item-text">{product_desc}</p>',
        ...
        lang: { // Language variables
            cartTitle: "Đơn hàng được tạo bởi " + $('#loginedName').text(),
            checkout: 'Đặt trước',
            clear: 'Xóa',
            subtotal: 'Tổng cộng:',
            cartRemove: '×',
            cartEmpty: '<span class="text-danger">Giỏ hàng của bạn hiện trống không ah ^_^<br />Chọn mua vài món nhé!</span>'
        },
        submitSettings: {
    ...
    $.extend(SmartCart.prototype, {
        ...
        _setElements: function () {
            ...
            this.cart_element.append('<div class="panel-heading sc-cart-heading">' + this.options.lang.cartTitle + '</br><span class="sc-cart-count badge">0</span> món </div>');
            ...
            if (this.options.toolbarSettings.showCheckoutButton) {
                ...
                switch (this.options.toolbarSettings.checkoutButtonStyle) {
                    ...
                    case 'image':
                        ...
                        break;
                    default:
                        btnCheckout = '<button class="btn btn-info sc-cart-checkout" type="button"  data-toggle="modal" data-target="#exampleModalCenter" >' + this.options.lang.checkout + '</button> ';
                        break;
                }
